    ...
    <main style={{background:'#0f0f0d',minHeight:'100vh',color:'#e8e4dc',fontFamily:"'DM Sans', sans-serif"}}>
      ...
      <div style={{padding:'0 2rem'}}>
        <div className="hero">
          ...
          <h1 className="headline">Why NYC reservations<br />are a different game.</h1>
          <p className="hero-sub">Getting a table at Carbone or Lilia has nothing to do with luck. It comes down to knowing exactly when the window opens and being ready before anyone else does.</p>
        </div>
        ...
        <div className="content">
          ...
          <div className="section">
            ...
            <h2 className="section-title">The reservation landscape has changed</h2>
          ...
          <div className="section">
            ...
            <h2 className="section-title">What a drop time is</h2>
            <div className="section-body">
          ...
          <div className="section">
            ...
            <h2 className="section-title">How the platforms differ</h2>
            <div className="section-body">
              ...
              <div className="platform-grid">
                <div className="platform-card">
                  ...
                  <div className="platform-desc">Home to most of the high-demand restaurants in NYC. Each restaurant controls its own release schedule and the information is not always consistent.</div>
                </div>
                <div className="platform-card">
                  <div className="platform-name">OpenTable</div>
                  <div className="platform-desc">A larger network with its own conventions around how booking windows are counted and displayed. More consistent in practice but gaps still exist.</div>
                </div>
                <div className="platform-card">
                  <div className="platform-name">DoorDash</div>
                  <div className="platform-desc">Has become the exclusive booking platform for a growing group of NYC restaurants. UI is by far the weakest and releases may not follow a standard pattern.</div>
                </div>
              </div>
          ...
          <div className="section">
            ...
            <h2 className="section-title">Where Scoopd fits in</h2>
            <div className="section-body">
          ...
          <div className="cta-block">
            <div className="cta-title">Be first to know.</div>
            <p className="cta-sub">Join the waitlist for exact drop date calculations, real-time alerts, and the full Scoopd platform when it launches.</p>

...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      description: `Reservation drop times and booking intel for ${neighborhood} restaurants.`,
  ...
  return (
    <main style={{ background: '#0f0f0d', minHeight: '100vh', color: '#e8e4dc', fontFamily: "var(--font-dm-sans), sans-serif", padding: '0' }}>
      ...
      <div style={{ padding: '3rem 2rem 1rem' }}>
        <p style={{ color: '#8a8a80', fontSize: '0.8rem', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Neighborhood</p>
        <h1 style={{ fontFamily: "var(--font-playfair), serif", fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 700, color: '#e8e4dc', margin: 0 }}>{neighborhood}</h1>
      </div>

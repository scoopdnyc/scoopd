...
export function computeNextDropDate(r, now = new Date()) {
  ...
  const restaurantDateBeforeDaysOut = new Date(restaurantDate)
  ...
  return { display, dateET: restaurantDate, releaseHour, releaseMinute, _debug: { etHour, etMinute, releaseHour, releaseMinute, beforeRelease, restaurantDateBeforeDaysOut: restaurantDateBeforeDaysOut.toDateString(), dateET: restaurantDate.toDateString() } }
}

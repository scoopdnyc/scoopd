...
One pattern worth understanding applies specifically to restaurants that charge cancellation fees. Most set a deadline, typically 24 to 48 hours before the reservation, after which cancelling costs money. Diners who know they can't make it will cancel before that deadline, not after. That means cancellations at fee restaurants tend to concentrate in the hours leading up to that cutoff rather than appearing randomly. A restaurant running seatings from 5 PM to 10 PM will see that pressure distributed across a similar window on the day prior, as each seating's deadline arrives at a different time. Checking a few times through that window isn't a guarantee, but it puts you in the right place at a higher-probability moment than checking at random.

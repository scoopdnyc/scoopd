...
The information required to compete fairly was always there -- the [drop times](/blog/rolling-windows-and-monthly-drops), the release windows, the exact moment a reservation becomes available on the exact platform where it lives. None of it was published, none of it was explained, and so the consumers who funded the secondary market did so, in many cases, because they didn't know there was another way. Access to that information doesn't cost anything. It never did. That it wasn't organized and surfaced is not a technical problem -- it is an editorial one, and editorial problems have always been solvable.
